...
<body>
	<div class="signin">
		...
		<form class="form-signin" role="form"
			action="${pageContext.request.contextPath}/auth/alterPassword"
			method="post">

			<h3 style="color: #8f4586">修改密码:</h3>
			...
			<input name="password1" type="passsword" class="form-control"
				placeholder="请输入密码" required autofocus />
			<input name="password2" type="passsword" class="form-control"
				placeholder="确定密码" required autofocus />
			<button class="btn btn-lg btn-warning btn-block" type="submit">确定修改密码</button>
